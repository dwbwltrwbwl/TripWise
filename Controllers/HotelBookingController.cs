        ...
        public async Task<IActionResult> ProcessBooking([FromBody] HotelBookingViewModel model)
        {
            try
            {
                ...
                var booking = new HotelBooking
                {
                    ...
                    PaymentMethod = "Банковская карта", // NOT NULL - обязательно!
                    TransactionId = "TXN" + DateTime.Now.Ticks.ToString().Substring(0, 12), // NOT NULL - обязательно!
            ...
            <body>
                <div class='booking'>
                    ...
                    <div class='price'>
                        ...
                        <p style='margin-top: 10px; font-size: 14px;'>Оплачено {booking.PaymentMethod ?? "банковской картой"}</p>
                    </div>
